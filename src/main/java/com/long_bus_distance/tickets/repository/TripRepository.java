...
public interface TripRepository extends JpaRepository<Trip, UUID> {
    ...
    Long countTripsForOperatorBetweenDates(@Param("operatorId") UUID operatorId, @Param("start") LocalDateTime start,
