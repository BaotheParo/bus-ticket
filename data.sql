...
-- BẢNG TRIPS
-- =================================================================
INSERT INTO trips (id, route_name, departure_time, departure_point, arrival_time, destination, duration_minutes, bus_type_id, status, base_price, operator_id, created_at, updated_at, sale_start, sale_end) VALUES
